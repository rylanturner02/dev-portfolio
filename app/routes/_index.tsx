      ...
      <header className="fixed bg-base-100 top-0 left-0 right-0 z-50">
        <div className="navbar">
          <div className="flex-1">
            <a style={{fontFamily: "Caprasimo, serif"}} className="btn btn-ghost sm:text-xl md:text-3xl tracking-wide">Rylan Turner&apos;s Portfolio</a>
          </div>
          <div className="flex-none">
            <a href="https://www.github.com/rylanturner02" className="btn btn-square btn-ghost">
